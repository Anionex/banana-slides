...
Use **Extra Fields** to enable, reorder, or add fields such as **Visual Focus** and **Layout**. The field list is stored in the current browser. If this cache was manually edited, came from an incompatible older version, or is temporarily unreadable or unwritable, the editor still opens normally, keeps usable custom fields, and restores missing defaults.
