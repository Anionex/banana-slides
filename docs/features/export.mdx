...
In the export dialog, you can enable **Only Text Layers Editable**. It is off by default. When enabled, Banana Slides keeps the full slide image as the background and overlays only detected text as editable text boxes, which is useful when visual fidelity matters most and you only need to edit copy.
