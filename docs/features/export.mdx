...
- When enabled: the system will continue whenever possible. For example, editable PPTX export can keep the original slide image as the page background when MinerU layout analysis fails for an individual page, and video export can fall back to silent clips for pages that do not have usable narration.
