...
On the preview page, click **Edit** and the current slide slides up while an instruction panel opens beneath it, so you edit while watching the full-size slide instead of a dialog covering it (narrow screens still fall back to a dialog):
