...
[AIHubMix](https://aihubmix.com/?aff=17EC) 是推荐的 API 中转服务，通过单一 OpenAI 兼容接口支持多家模型提供商。只需一个 API Key 即可访问 Gemini、GPT、Claude 等模型。[点击此处申请 AIHubMix API Key](https://aihubmix.com/token?aff=17EC)。
