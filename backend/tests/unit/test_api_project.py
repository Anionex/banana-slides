...
@pytest.mark.parametrize(('raw_error', 'expected'), [
    ...
    ('OpenAI OAuth is not connected. Please connect in Settings.', 'OpenAI OAuth is not connected'),
    ('401 Unauthorized: usage limit has been exhausted', 'API quota or balance is insufficient'),
    ('401 Unauthorized: balance is insufficient', 'API quota or balance is insufficient'),
