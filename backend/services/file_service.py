...
class FileService:
    ...
    def save_template_image(self, file, project_id: str) -> str:
        ...
        return str(filepath.relative_to(self.upload_folder)).replace('\\', '/')
    ...
    def delete_page_image_version(self, image_path: str) -> bool:
        ...
        Args:
            image_path: Relative path to the image file (with forward slashes)
    ...
    def get_absolute_path(self, relative_path: str) -> str:
        ...
        Args:
            relative_path: Relative path from upload folder (with forward slashes)
