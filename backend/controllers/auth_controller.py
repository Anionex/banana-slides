...
from models import db, User, PointsTransaction
from services.sms_service import create_sms_code, verify_sms_code, check_rate_limit, send_sms
...
def login_phone():
    ...
    if not user:
        # Auto-register on first login via phone
        user = User(
            phone=phone,
            role='user',
            points=100,
