...
<tr>
<td width="220" align="center" valign="middle"><a href="https://www.byteplus.com/en/product/modelark?utm_campaign=hw&utm_content=banana-slides&utm_medium=devrel_tool_web&utm_source=OWO&utm_term=banana-slides"><img src="./assets/byteplus.png" alt="BytePlus ModelArk" width="189"></a></td>
...
- **[2026-08-29]**: Release Candidate 5 of v0.9.0 is available, adding an immersive online slide player and an APIMart OpenAI-compatible provider preset, while fixing desktop update checks so RC builds correctly follow the prerelease channel. It also improves MinerU credential guidance for PPT renovation, blocks SSRF through remote images in reference documents, and opens the image editor in region-selection mode by default; [View downloads and installation instructions](https://github.com/Anionex/banana-slides/releases/tag/v0.9.0-rc.5)
