...
- Enable **Only Text Layers Editable** before export to keep the full slide image as the background and make only detected text editable. This option is off by default.
