...
const homeI18n = {
  zh: {
    ...
    presetStyles: {
      businessSimple: {
        name: '商务简约',
        description: '简约商务风格，以蓝色和白色为主色调，布局整洁大方，适合商业汇报和企业展示',
      },
      techModern: {
        name: '科技现代',
        description: '现代科技风格，深色背景搭配亮色点缀，几何元素和渐变效果，适合科技产品和技术分享',
      },
      academicFormal: {
        name: '学术正式',
        description: '正式学术风格，经典配色方案，清晰的层次结构和图表排版，适合学术报告和论文答辩',
      },
      creativeFun: {
        name: '创意趣味',
        description: '创意趣味风格，色彩丰富活泼，手绘元素和卡通插画，适合创意展示和教育培训',
      },
      minimalistClean: {
        name: '极简清新',
        description: '极简清新风格，大量留白，柔和色调和简洁线条，突出内容本身，适合文艺和生活类主题',
      },
      luxuryPremium: {
        name: '奢华高端',
        description: '奢华高端风格，金色和深色搭配，精致纹理和高级质感，适合品牌发布和高端活动',
      },
      natureFresh: {
        name: '自然清新',
        description: '自然清新风格，绿色和大地色系，自然元素和有机形状，适合环保和健康类主题',
      },
      gradientVibrant: {
        name: '渐变活力',
        description: '渐变活力风格，大胆的渐变色彩和动感元素，视觉冲击力强，适合潮流和年轻化主题',
      },
    },
    home: {
      title: '蕉幻',
