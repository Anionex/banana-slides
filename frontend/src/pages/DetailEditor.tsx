...
const detailI18n = {
  zh: {
    ...
    detail: {
      ...
      parallel: "并行",
      extraFields: "额外字段",
      extraFieldsHint: "启用后，AI 生成描述时会带上这些字段。点击胶囊启用/禁用，拖拽调整顺序。",
      addField: "添加字段",
  ...
  en: {
    ...
    detail: {
      ...
      extraFieldsHint: "When enabled, AI will include these fields when generating descriptions. Click pills to enable/disable, drag to reorder.",
      addField: "Add Field",
