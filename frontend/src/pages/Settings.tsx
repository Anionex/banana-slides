...
const initialFormData = {
  ...
  image_caption_model: 'gemini-3-flash-image-preview',
  mineru_api_base: '',
  mineru_token: '',
  image_resolution: '2K',
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          locked: true,
          lockedValue: 'gemini-3-flash-preview',
        },
      ],
    },
    {
    ...
    try {
      ...
      if (response.data) {
        ...
        setFormData({
          ...
          text_model: response.data.text_model || 'gemini-3-flash-preview',
          image_model: response.data.image_model || 'gemini-3-pro-image-preview',
          mineru_api_base: response.data.mineru_api_base || '',
          mineru_token: '',
          image_caption_model: response.data.image_caption_model || 'gemini-3-flash-preview',
