  ...
  zh: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageAspectRatio: "画面比例",
        imageAspectRatioDesc: "生成图片时使用的宽高比（影响构图与画布尺寸）",
  ...
  en: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageAspectRatioDesc: "Aspect ratio used when generating images (affects composition and canvas size)",
    ...
    },
    {
      ...
      fields: [
        ...
        },
        {
          ...
          label: t('settings.fields.imageAspectRatio'),
          type: 'select',
          description: t('settings.fields.imageAspectRatioDesc'),
          options: [
