...
export interface Settings {
  ...
  admin_init_password_length: number;
  admin_init_password_masked?: string;
  sms_provider?: string;
  sms_access_key_id?: string;
  sms_access_key_secret_length: number;
  sms_access_key_secret_masked?: string;
  sms_sign_name?: string;
  sms_template_code?: string;
  sms_endpoint?: string;
  sms_code_ttl_minutes?: number;
  sms_rate_limit_per_day?: number;
  sms_mock_code?: string;
  wechat_pay_enabled?: boolean;
  wechat_pay_mock?: boolean;
  wechat_pay_app_id?: string;
  wechat_pay_mch_id?: string;
  wechat_pay_serial_no?: string;
  wechat_pay_private_key_length: number;
  wechat_pay_private_key_masked?: string;
  wechat_pay_api_v3_key_length: number;
  wechat_pay_api_v3_key_masked?: string;
  wechat_pay_gateway_url?: string;
  wechat_pay_notify_url?: string;
  wechat_pay_order_expire_minutes?: number;
  created_at?: string;
  updated_at?: string;
}
