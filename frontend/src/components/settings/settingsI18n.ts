  ...
  zh: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageQuality: "图片质量档位",
        imageQualityDesc: "仅对 GPT Image / DALL·E 模型生效。xhigh 和 max 需要 gpt-image-2.5 及更新模型，旧模型会自动回落到 high",
  ...
  en: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageQualityDesc: "Only applies to GPT Image / DALL·E models. xhigh and max require gpt-image-2.5 or newer; older models fall back to high",
