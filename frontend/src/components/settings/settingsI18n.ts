  ...
  zh: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageQuality: "图片质量档位",
        imageQualityDesc: "仅对 GPT Image 模型生效（DALL·E 3 固定 standard）。xhigh 和 max 需要 gpt-image-2.5 及更新模型，旧模型会自动回落到 high",
        imageQualityAuto: "自动（auto）",
        imageQualityLow: "低（low）",
        imageQualityMedium: "中（medium）",
        imageQualityHigh: "高（high）",
        imageQualityXhigh: "更高（xhigh）",
        imageQualityMax: "最高（max）",
      },
      apiKeyHelp: {
        title: "如何获取 API 密钥",
  ...
  en: {
    ...
    settings: {
      ...
      fields: {
        ...
        imageQualityDesc: "Only applies to GPT Image models (DALL·E 3 stays on standard). xhigh and max require gpt-image-2.5 or newer; older models fall back to high",
        imageQualityAuto: "Auto",
        imageQualityLow: "Low",
        imageQualityMedium: "Medium",
        imageQualityHigh: "High",
        imageQualityXhigh: "X-High",
        imageQualityMax: "Max",
      },
      apiKeyHelp: {
