...
const projectSettingsI18n = {
  zh: {
    projectSettings: {
      ...
      iconSubjectExtractionTip: "基于 RMBG-2.0 ONNX 模型本地推理，首次使用会自动下载约 1GB 模型；单张图标处理失败时会自动回退到原矩形裁剪，不影响导出。",
  ...
  en: {
    projectSettings: {
      ...
      iconSubjectExtractionTip: "Powered by local RMBG-2.0 ONNX inference. The ~1GB model is downloaded automatically on first use. If extraction fails for an individual icon, it falls back silently to the original rectangular crop without affecting export.",
